...
# browser.execute_script("window.scrollTo(0,2000)") # 1920 X 1080
# browser.execute_script("window.scrollTo(0,3000)") # 1920 X 1080
...
movies = soup.find_all("div",attrs = {"class":["Vpfmgd"]}) # 리스트로 해서 클래스명 두개 가져오기
print(len(movies))
